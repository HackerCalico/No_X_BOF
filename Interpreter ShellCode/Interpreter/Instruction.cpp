...
int InvokeInstruction(int mnemonicIndex, char opType1, char opBit1, DWORD_PTR opAddr1, char opBit2, DWORD_PTR opAddr2, PDWORD_PTR pVtRegs) {
    PVOID mnemonicMapping[] = {Push, Pop, AsmCall, Ret, Mov, AsmMovsx, AsmMovzx, Movsxd, Lea, Add, Inc, Sub, AsmCmp, Imul, And, Or, Xor, AsmTest, Shl, Cdqe, RepStosb, Jmp, AsmJe, AsmJne, AsmJbe, AsmJl, AsmJle};
